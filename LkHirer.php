    ...
    <nav class="navbar">
      <div class="container">
        ...
        <ul class="nav-menu">
		  ...
		  <li>
            <a class="active" href="LkHirer.php">Личный кабинет</a>
          </li>
		</ul>
      </div>
    </nav>
    <form action="db/LkUpHirer.php" method="post">
		...
		<center>На данной странице Вы можете просмотреть свои личные данные и изменить некоторые из них при необходимости. В случае изменения данных необходимо заполнить все поля (даже те, которые остаются прежними)</center><br>
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-5">
			  ...
			  <div class="form-group">
			  <small>Название компании: '.$data[$i]["company"].'</small>
                <input type="text" class="form-control" name ="company" id="company" placeholder= "Новое название без ковычек и других знаков">
              </div>
			  ';
				}
		  ?>
