<?php
	...
	connectDB();
	$mysqli->query("INSERT INTO `resume` (`fio`, `vacancy_title`, `personal_inf`, `city`, `salary`, `age`, `phone`, `email`, `education_level`, `graduation_year`, `study_place`, `organisation`, `website`, `duty`, `begin_work`, `finish_work`, `language`, `lang_level`, `date`) 
	VALUES('$fio', '$vacancy_title', '$personal_inf', '$city', '$salary', '$age', '$phone', '$email', '$education_level', '$graduation_year', '$study_place', '$organisation', '$website', '$duty', '$begin_work', '$finish_work', '$language', '$lang_level', NOW())");
