	  ...
	  <section>
        <div class="container">
          ...
          <div class="row item-blocks-connected">
			...
			авторизоваться. С помощью данного сайта пользователи могут просмотреть вакансии, создать резюме, после 
			чего просмотреть их, а так же просмотреть имеющиеся вакансии.</h5>
	  ...
	  <section style="background-color:rgb(214, 128, 72)">
        <div class="container">
          ...
          <div class="row item-blocks-connected">
			...
			<div class="col-xs-3">
				<div style="text-align:center">
				<h5 style="color:#fff">php</h5>
				</div>
			</div>
			<div class="col-xs-3">
				<div style="text-align:center">
				<h5 style="color:#fff">MySql</h5>
				</div>
			</div>
		  </div>
		</div>
          ...
          <form class="form-enter" action="#">
            <div class="input-group">
              <span class="input-group-btn">
                <a class="btn btn-success btn-lg" href="index1.php">Перейти</a>
              </span>
            </div>
          </form>
        </div>
